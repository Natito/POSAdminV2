...
public class Corte implements Serializable {
    ...
    public Corte(int id_folio, Date fecha, Usuario id_usuario, long ventafolio_from, long ventafolio_to, double total_preciocompra, double total_precioventa, int numero_de_ventas, double total_corte, double efvoInicial, double efvoVaja) {
    ...
    private long ventafolio_from = 0;
    @Column(name = "FOLIOVENTA_TO")
    private long ventafolio_to = 0;
    ...
    private int numero_de_ventas = 0;
    ...
    public long getVentafolio_from() {
        return ventafolio_from;
    }

    public void setVentafolio_from(long ventafolio_from) {
        this.ventafolio_from = ventafolio_from;
    }

    public long getVentafolio_to() {
        return ventafolio_to;
    }

    public void setVentafolio_to(long ventafolio_to) {
        this.ventafolio_to = ventafolio_to;
    }
