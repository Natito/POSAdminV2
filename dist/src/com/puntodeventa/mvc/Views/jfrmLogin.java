...
import com.puntodeventa.global.Util.*;
...
public class jfrmLogin extends javax.swing.JFrame {
    ...
    ValidacionForms valForms = new ValidacionForms();
    ...
    private void configureControls() {
        ...
        this.jtxtUsuario.setDocument(new TextLimiter(Integer.parseInt(ParamHelper.getParam("jfrmLogin.jtxtUsuario").toString())));
    ...
    private void initComponents() {
        ...
        jtxtUsuario.setToolTipText("Aqui se escribe su nombre de usuario para acceder al sistema"); // NOI18N
    ...
    private void jBtnEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnEntrarActionPerformed
        if (this.jtxtUsuario.getText().equals("")) {
            ...
            try {
                ...
                util.saveOrUpdateProperties(user, pwd);
                ...
                if (usr != null) {
                    if (usr.getBloqueo() == 1) {
                        ...
                        PuntoVentaMDI mdi = new PuntoVentaMDI(usr.getId_usuario());
                        mdi.setVisible(true);
                    }
                } else {
