...
public class CorteDS implements JRDataSource{
    private List<CorteCaja> listCorte = new ArrayList<>();
    ...
    public void addCompraList(CorteCaja corte){
