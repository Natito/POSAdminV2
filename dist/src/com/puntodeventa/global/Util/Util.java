...
public class Util {
    ...
    public static void saveOrUpdateProperties(String user, String password) {
        try {
            String pathProperties = System.getProperty("user.dir") + "/src/";
            Properties p = new Properties();
            p.load(new FileInputStream(pathProperties + "config_db.properties"));
            p.setProperty("hibernate.connection.username", user);
            p.setProperty("hibernate.connection.password", password);
            FileOutputStream salida;
            try {
                salida = new FileOutputStream(pathProperties + "config_db.properties");
                p.save(salida, "By Nato");
